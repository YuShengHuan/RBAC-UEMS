<template>
  ...
  >
    <template #topOperate="{pageParameter}">
      <el-button :icon="Plus" type="primary" @click="handleCreate" v-permission="'noticeConfirm:create'">创建</el-button>
      <el-button :icon="TopLeft" type="success" @click="handleExport(pageParameter)" v-permission="'noticeConfirm:export'">导出</el-button>
    </template>
    <template #rowOperate="{index,row}">
      <el-button :icon="Edit" type="primary" @click="handleEdit(row)" v-permission="'noticeConfirm:update'">编辑</el-button>
      <el-button :icon="Delete" type="danger" @click="handleDelete(row)" v-permission="'noticeConfirm:delete'">删除</el-button>
    </template>
  </FreedomDataManage>
  <AdminSysNoticeConfirmForm
      ref="formViewRef"
      :base-api="baseApi"
...
import  AdminSysNoticeConfirmForm from '../notice/form/AdminSysNoticeConfirmForm.vue'
...
import  {tableDataConfig,filterFormConfig,baseApi} from "../../../config/module/AdminSysNoticeConfirmConfig"
