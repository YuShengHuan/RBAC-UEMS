<template>
  ...
  >
    <template #topOperate="{pageParameter}">
      <el-button :icon="Plus" type="primary" @click="handleCreate" v-permission="'role:create'">创建</el-button>
      <el-button :icon="TopRight" type="success" @click="handleImport" v-permission="'role:batchInsert'">导入</el-button>
      <el-button :icon="TopLeft" type="success" @click="handleExport(pageParameter)" v-permission="'role:export'">导出</el-button>
    </template>
    <template #rowOperate="{index,row}">
      <el-button :icon="Edit" type="primary" @click="handleEdit(row)" v-permission="'role:update'">编辑</el-button>
      <el-button :icon="Delete" type="danger" @click="handleDelete(row)" v-permission="'role:delete'">删除</el-button>
    </template>
  </FreedomDataManage>
  <AdminSysRoleForm
      ref="formViewRef"
...
import  AdminSysRoleForm from '../authority/form/AdminSysRoleForm.vue'
...
import  {tableDataConfig,filterFormConfig,baseApi,importFormConfig} from "../../../config/module/AdminSysRoleConfig"
import {ref} from "vue";
