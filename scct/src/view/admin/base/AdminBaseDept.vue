<template>
  ...
  >
    <template #topOperate="{pageParameter}">
      <el-button :icon="Plus" type="primary" @click="handleCreate" v-permission="'dept:create'">创建</el-button>
      <el-button :icon="TopRight" type="success" @click="handleImport" v-permission="'dept:batchInsert'">导入</el-button>
      <el-button :icon="TopLeft" type="success" @click="handleExport(pageParameter)" v-permission="'dept:export'">导出</el-button>
      <el-button :icon="Delete" type="danger" @click="handleBatchDelete(pageParameter)" v-permission="'dept:batchDelete'">批量删除</el-button>
    </template>
    <template #rowOperate="{index,row}">
      <el-button :icon="Edit" type="primary" @click="handleEdit(row)" v-permission="'dept:update'">编辑</el-button>
      <el-button :icon="Delete" type="danger" @click="handleDelete(row)" v-permission="'dept:delete'">删除</el-button>
    </template>
  </FreedomDataManage>
  <AdminBaseDeptForm
      ref="formViewRef"
...
import  AdminBaseDeptForm from '../base/form/AdminBaseDeptForm.vue'
import  ImportDataView from '../../../components/common/table/ImportDataView.vue'
import {Delete,Edit,TopLeft,TopRight,Plus} from '@element-plus/icons-vue'
import FreedomDataManage  from '../../../components/common/table/FreedomDataManage.vue'
import  {tableDataConfig,filterFormConfig,baseApi,importFormConfig} from "../../../config/module/AdminBaseDeptConfig"
import {ref} from "vue";
