<template>
  ...
  >
    <template #topOperate="{pageParameter}">
      <el-button :icon="Plus" type="primary" @click="handleCreate" v-permission="'course:create'">创建</el-button>
      <el-button :icon="TopRight" type="success" @click="handleImport"  v-permission="'course:batchInsert'">导入</el-button>
      <el-button :icon="TopLeft" type="success" @click="handleExport(pageParameter)"  v-permission="'course:export'">导出</el-button>
      <el-button :icon="Delete" type="danger" @click="handleBatchDelete(pageParameter)" v-permission="'course:batchDelete'">批量删除</el-button>
    </template>
    <template #rowOperate="{index,row}">
      <el-button :icon="Edit" type="primary" @click="handleEdit(row)"  v-permission="'course:update'">编辑</el-button>
      <el-button :icon="Delete" type="danger" @click="handleDelete(row)" v-permission="'course:delete'">删除</el-button>
    </template>
  </FreedomDataManage>
  <AdminExpCourseForm
      ref="formViewRef"
...
import  AdminExpCourseForm from '../exp/form/AdminExpCourseForm.vue'
...
import  {tableDataConfig,filterFormConfig,baseApi,importFormConfig} from "../../../config/module/AdminExpCourseConfig"
import {ref} from "vue";
