<template>
  ...
  >
    <template #topOperate="{pageParameter}">
      <el-button :icon="Plus" type="primary" @click="handleCreate" v-permission="'notice:create'">创建</el-button>
      <el-button :icon="TopLeft" type="success" @click="handleExport(pageParameter)" v-permission="'notice:export'">导出</el-button>
    </template>
    <template #rowOperate="{index,row}">
      <el-button :icon="Edit" type="primary" @click="handleEdit(row)" v-permission="'notice:update'">编辑</el-button>
      <el-button :icon="Delete" type="danger" @click="handleDelete(row)" v-permission="'notice:delete'">删除</el-button>
    </template>
  </FreedomDataManage>
  <AdminSysNoticeForm
      ref="formViewRef"
...
import  AdminSysNoticeForm from '../notice/form/AdminSysNoticeForm.vue'
...
import  {tableDataConfig,filterFormConfig,baseApi} from "../../../config/module/AdminSysNoticeConfig"
