<template>
  ...
  >
    <template #topOperate="{pageParameter}">
      <el-button :icon="Plus" type="primary" @click="handleCreate" v-permission="'dict:create'">创建</el-button>
      <el-button :icon="TopRight" type="success" @click="handleImport" v-permission="'dict:batchInsert'">导入</el-button>
      <el-button :icon="TopLeft" type="success" @click="handleExport(pageParameter)" v-permission="'dict:export'">导出</el-button>
      <el-button :icon="Delete" type="danger" @click="handleBatchDelete(pageParameter)" v-permission="'dict:batchDelete'">批量删除</el-button>
    </template>
    <template #rowOperate="{index,row}">
      <el-button :icon="Edit" type="primary" @click="handleEdit(row)" v-permission="'dict:update'">编辑</el-button>
      <el-button :icon="Delete" type="danger" @click="handleDelete(row)" v-permission="'dict:delete'">删除</el-button>
    </template>
  </FreedomDataManage>
  <AdminSysDictForm
      ref="formViewRef"
...
import  AdminSysDictForm from '../dict/form/AdminSysDictForm.vue'
...
import  {tableDataConfig,filterFormConfig,baseApi,importFormConfig} from "../../../config/module/AdminSysDictConfig"
import {ref} from "vue";
