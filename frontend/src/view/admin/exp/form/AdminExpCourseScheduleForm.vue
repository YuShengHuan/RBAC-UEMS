...
import {weekDayOptions,weekTypeOptions} from "../../../../utils/globalOptionsUtil"
...
// 初始化下拉选项
onMounted(async () => {
  let teachingCoreRes = await request.get(`/api/admin/teaching-core/select`)
  if (teachingCoreRes.status === 200) {
    teachingCoreOptions.value = teachingCoreRes.data
  }
